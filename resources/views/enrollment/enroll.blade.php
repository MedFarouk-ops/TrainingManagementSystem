        ...
        <div class="section-top-border">
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <h3 class="mb-30">Submit an application for formation enrollment</h3>
                    @guest
                        <p>If you have account, login with your credentials <a href="{{ route('enroll.handleLogin', ['id' => $formation->id]) }}">here</a>.</p>
                    @endguest
                    <form method="POST" action="{{ route('enroll.store', ['id' => $formation->id]) }}">
                        @csrf
                        <div class="mt-10">

...
<body>
    ...
    <div class="form-group">
         <h2><strong>Supprimer l'inscription de {{$user->name}} </strong></h2>
         <hr>
    <form action="{{route('permission.delete.submit',$permission->id)}}" method="post">
        @csrf
        @method('DELETE')
         ...
         <div class="modal-footer">
            ...
            <input type="submit" class="btn btn-danger" class="btn btn-danger" value="Supprimer">
             <a href="{{ route('admin.user.permission')}}" class="btn btn-info"> annuler </a>
         </div>
    </form>
    </div>
    </div>
